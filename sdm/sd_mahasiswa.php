        ...
        <div class="heading w3-flat-peter-river">
            <div class="w3-cell w3-cell-middle w3-padding">
                <div id="mySidenav" class="sidenav" >
                    ...
                    <a href="sd_mahasiswa.php">Sumber Daya Mahasiswa</a>
                    <a href="keuangan_sarana_prasarana.php">Keuangan, Sarana, dan Prasarana</a>
                    <a href="../pendidikan/pendidikan.php">Pendidikan</a>
                    <a href="penelitian.php">Penelitian</a>
                    <a href="pkm.php">Pengabdian Kepada Masyarakat</a>
