...
<head>
    ...
    <div id="table">
        <h1>Ekuivalen Waktu Mengajar Penuh (EWMP)</h1>
        <table>
            <tr>
                <th rowspan="3">No.</th>
            ...
            <tr>
                <th colspan="6">Ekuivalen Waktu Mengajar Penuh (EWMP) pada saat TS <br> dalam satuan kredit semester (sks)</th>
                <th rowspan="3">Jumlah <br> (sks)</th>
                <th rowspan="3">Rata-rata<br>per<br>Semester<br>(sks)</th>
            </tr>
            <tr>
            ...
            $conn = new DB();
            $hasil = $conn->executeStoredProcedure("EXEC Tabel3a3_EWMPDosenTetapPerguruanTinggi", []);
