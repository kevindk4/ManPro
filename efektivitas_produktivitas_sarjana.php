...
<html>
    ...
    <body>
        ...
        <div id="table">
            <h1>Efektivitas dan Produktivitas Pendidikan</h1>
            <table>
                <tr>
                    <th>Tahun Masuk</th>
                    <th>Jumlah Mahasiswa Diterima</th>
                    <!-- <th>Jumlah Mahasiswa yang Lulus pada</th>
                    <th>Jumlah Lulusan s.d. Akhir TS</th>
                ...
                <?php
                    ...
                    $sql = "SELECT TOP (1000) [ts]
                            ,[jml]
                        FROM [Akreditasi2020].[dbo].[v_8c_ts6]";
                    ...
                    $sql = "SELECT TOP (1000) [ts]
                            ,[jml]
                        FROM [Akreditasi2020].[dbo].[v_8c_ts5]";
                    $stmt = sqlsrv_query( $conn, $sql );
                    if( $stmt === false) {
                        die( print_r( sqlsrv_errors(), true) );
                    }
                    ...
                    $sql = "SELECT TOP (1000) [ts]
                            ,[jml]
                        FROM [Akreditasi2020].[dbo].[v_8c_ts4]";
                    $stmt = sqlsrv_query( $conn, $sql );
                    if( $stmt === false) {
                        die( print_r( sqlsrv_errors(), true) );
                    }
                    ...
                    $sql = "SELECT TOP (1000) [ts]
                            ,[jml]
                        FROM [Akreditasi2020].[dbo].[v_8c_ts3]";
                    $stmt = sqlsrv_query( $conn, $sql );
                    if( $stmt === false) {
                        die( print_r( sqlsrv_errors(), true) );
                    }
