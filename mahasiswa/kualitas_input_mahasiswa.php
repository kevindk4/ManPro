    ...
    <body>
        ...
        .tg .tg-0lax{
            ...
            <tr>
                ...
                <th class="tg-uyni" rowspan="2">Daya Tampung</th>
                <th class="tg-uyni" colspan="2">Jumlah Calon Mahasiswa</th>
                <th class="tg-uyni" colspan="2">Jumlah Mahasiswa Baru</th>
                <th class="tg-uyni" colspan="2">Jumlah Mahasiswa Aktif</th>
            </tr>
            <tr>
                <th class="tg-uyni" >Pendaftar</th>
                <th class="tg-uyni" >Lulus Seleksi</th>
                <th class="tg-uyni" >Reguler</th>
                <th class="tg-uyni" >Transfer</th>
                <th class="tg-uyni" >Reguler</th>
                <th class="tg-uyni" >Transfer</th>
            </tr>
            <tr>
                <td class="tg-9wq8">TS-4</td>
                <td class="tg-9wq8"></td>
                <td class="tg-9wq8"></td>
                <td class="tg-9wq8"></td>
                <td class="tg-9wq8"></td>
